...
<?php
/*
   Template Name: Member-inflection Page Template 
*/
get_header('member');
?>
...
<h4 class="">CEO Inflection Point (IP)</h4>
<h6 class="blue-grey-text text-darken-4">Restricted to CEOs</h6>
</div>
<div class="card" style="margin-top: 40px;">
<div class="card-image">
<img alt="" class="" src="<?php bloginfo("template_directory"); ?>/images/content/member-infection-1.png"/>
</div>
</div>
</section>
</div>
