...
<div class="carousel-item black white-text hero-image" href="#one!" style="background-image: url(<?php bloginfo("template_directory"); ?>/images/slider/hero.png);">
...
<a class="btn waves-effect light-blue white-text darken-text-2 bold-text-600 text-shadow-1-black" href=<?php echo get_permalink( get_page_by_path('membership')); ?>">
                            Become a Member
                        </a>
<p> </p>
</div>
</div>
<div class="carousel-item grey darken-4 white-text hero-image" href="#two!" style="background-image: url(<?php bloginfo("template_directory"); ?>/images/slider/hero.png);">
<div class="hero-content">
<h1>CEO Netweavers</h1>
<h2 class="white-text hero-subtitle">
<span class="light-blue-text hero-subtitle-text">
...
<a class="btn waves-effect light-blue white-text darken-text-2 bold-text-600 text-shadow-1-black" href="">
                            Become a Member
                        </a>
<p> </p>
</div>
...
<a class="btn grey lighten-2 black-text" href=<?php echo get_permalink( get_page_by_path('membership')); ?> ">Learn More</a>
</div>
</div>
</div>
<div class="col s12 m4">
...
<div class="card-action center-align">
<a class="btn grey lighten-2 black-text" href=<?php echo get_permalink( get_page_by_path('partnership')); ?> ">Learn More</a>
</div>
</div>
</div>
</div>
...
<h6 class="blue-grey-text text-darken-4" data-aos="fade-right">Investing in our Business Community</h6>
</div>
<div class="outreach-grid">
<div class="card-panel hoverable grey lighten-4" data-aos="fade-right" style="margin-bottom: 5px;">
...
<div class="card blue-grey lighten-4 image-panel hide-on-small-only" data-aos="zoom-in" style="margin-bottom: 5px;">
<div class="card-image">
...
<div>
<div class="col s12">
<div class="card-panel hoverable white" data-aos="fade-left" style="height: 290px; margin-bottom: 5px;">
<span class="black-text">
...
<div class="col s12">
<div class="card" data-aos="zoom-in" style="margin-bottom: 5px;">
<div class="card-image">
...
<div class="card blue-grey lighten-4 image-panel" data-aos="zoom-in">
<div class="card-image">
...
<div class="card-panel hoverable grey lighten-4" data-aos="fade-left" style="height: 304px;">
<span class="black-text">
...
<div class="card hoverable col s12 m4" data-aos="zoom-out">
<div class="card-image">
...
<div class="card hoverable" data-aos="zoom-out">
<div class="card-image">
...
<div class="row">
<div class="col s12 m4 sponsor center" data-aos="zoom-in">
<a href="https://www.cricpa.com/ " target="_blank ">
<img alt=" " src="<?php bloginfo("template_directory"); ?>/images/sponsors/cri-logo.png "/>
</a>
</div>
<div class="col s12 m4 sponsor center" data-aos="zoom-in">
<a href="https://coles.kennesaw.edu/emba/index.php " target="_blank ">
<img alt=" " src="<?php bloginfo("template_directory"); ?>/images/sponsors/EMBA-Logo.png "/>
</a>
</div>
<div class="col s12 m4 sponsor center" data-aos="zoom-in">
<a href="https://www.epiuse.com/aws-services/ " target="_blank ">
<img alt=" " src="<?php bloginfo("template_directory"); ?>/images/sponsors/EPIUSE-logo.png "/>
</a>
</div>
<div class="col s12 m4 sponsor center" data-aos="zoom-in">
<a href="https://www.eyemailinc.com/ " target="_blank ">
<img alt=" " src="<?php bloginfo("template_directory"); ?>/images/sponsors/EyeMail-logo.png "/>
</a>
</div>
<div class="col s12 m4 sponsor center" data-aos="zoom-in">
<a href="https://leedavislawllc.com/ " target="_blank ">
<img alt=" " src="<?php bloginfo("template_directory"); ?>/images/sponsors/LeeDavisLaw-Logo.png "/>
</a>
</div>
<div class="col s12 m4 sponsor center" data-aos="zoom-in">
<a href="https://www.thevideomarketingauthority.com/ " target="_blank ">
<img alt=" " src="<?php bloginfo("template_directory"); ?>/images/sponsors/vLink-Logo.png "/>
</a>
</div>
<div class="col s12 m4 sponsor center" data-aos="zoom-in">
<a href="https://www.thecapitalgrille.com/home " target="_blank ">
<img alt=" " src="<?php bloginfo("template_directory"); ?>/images/sponsors/the-capital-logo.png "/>
</a>
</div>
</div>
</section>
