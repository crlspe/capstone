                                ...
                                <div class="col s9 offset-s1 offset-m1 offset-l3">
                                        <section style="padding-left: 50px;">
                                                <div class="center-align">
                                                        <h4 class="">Monthly Speaker Series</h4>
                                                </div>
                                                <p class="blue-grey-text text-darken-4"> Meet and mingle with other
                                                ...
                                                <!-- <div class="card" style="margin-top: 40px;">
                                                        <div class="card-image">
                                                                <img alt="" class="" src="<?php bloginfo("template_directory");
                                                                        ?>/images/content/breakfast-1.png"/>
                                                        </div>
                                                </div> -->
                                                <div>
