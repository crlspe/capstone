...
<?php
/*
   Template Name: Header Page Template 
*/
    get_header();
?>
...
<li class="divider"></li>
<li><a class="black-text" href=<?php echo get_permalink( get_page_by_path('index')); ?>">Home</a></li>
<li class="divider"></li>
...
<a class="black-text" href=<?php echo get_permalink( get_page_by_path('k12')); ?>" style="font-size: .85rem;">
                                    K-12 Entrepreneurship and Education Program
                                </a>
</li>
<li>
