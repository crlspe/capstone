...
<div class="container">
<!-- TITLE -->
<div class="top-section page-title" id="faq-page">
...
<br/>
<p>
                        The purpose of CEO Netweavers FAQ’s is to help frame clearly why our organization exists and
                        what it envisions to be.
                    </p>
</span>
</div>
<div class="card" style="margin: 0px;">
<div class="card-image">
<img alt="" class="image-title" src="<?php bloginfo("template_directory"); ?>/images/titles/faq.png"/>
</div>
</div>
</div>
<!-- /TITLE -->
...
<p class="justify-text">
                    The Questions and Answers are designed to bring clarity around the community we are trying to
                    create, who our members are and why we engage in the activities we engage in together. </p>
</span>
</div>
<!-- Organization -->
<section class="border grey lighten-4" id="faq-content">
<div class="center-align">
<h4 class="">The Organization</h4>
...
<li>
<div class="collapsible-header">
<i class="material-icons">info_outline</i> What do we mean by Trusted Advisor?
                    </div>
<div class="collapsible-body">
<span>
...
<p>
<br/>- Demonstrated Servant Leadership evidenced by breadth and depth of civic, educational, religious, or other pay-it-forward activities, preferably in a leadership capacity
                                <br/>- Statement of Active Engagement
                                <br/>- Sponsored for membership by a member of CEO Netweavers
                            </p>
<p><b>Additional Business Requirements for CEO Members (Any one of below)</b></p>
<p>
<br/>- Active CEO of a company with minimum $3M in revenue AND a fiduciary board of directors
                               <br/>- CEO or Executive Director of a Not-For-Profit with annual revenues of $2.5m (includes civic leaders, College/University President or Dean)
                               <br/>- Board of Director members with fiduciary responsibilities for a public company or private company with $50M annual revenues or more
                               <br/>- Current direct report to enterprise CEO with full P&amp;L within $100M+ annual revenue company
...
<li>
<div class="collapsible-header">
<i class="material-icons">info_outline</i> What is the process for nominating and how long does it take to become a member of CEO Netweavers?
                    </div>
<div class="collapsible-body">
<span>
                            ...
                            <p>
<br/>- The candidate is invited to attend up to two (2) monthly meetings to get a feel for our organization before applying for membership;
                                <br/>- The CEO Netweavers member who invited the potential candidate and a member of the membership Committee discuss the candidate’s membership criteria and interest in our organization;
                                <br/>- If the CEON member (sponsor) recommends the candidate for membership, the sponsor or a member of the Membership Committee provides the candidate the membership application link to apply;
                                <br/>- The candidate completes the application, which is then reviewed by the Membership Committee against our stated criteria.  If the candidate meets the criteria, then two interviews are set up with the candidate:  one with a member of the Membership Committee and one with a member of the Operating Committee;
                                <br/>- The Executive Director and the membership Committee Chair review the interview results and follow-up with the candidate or sponsor if further clarification is needed;
                                <br/>- The interview results are reviewed with the entire membership committee and a decision is made on whether or not to recommend the candidate for membership;
                                <br/>- If the Membership Committee supports extending an invitation to join, the Chair of the Membership Committee recommends the candidate for membership at the next Operating Committee meeting;
                                <br/>- If the candidate does not meet the criteria outlined for membership, the Membership Committee Chair will discuss with the CEO member (sponsor) and the decision is then communicated to the candidate.
                            </p>
</span>
</div>
</li>
<li>
<div class="collapsible-header">
<i class="material-icons">info_outline</i> What are the different ways I can get more involved as a CEON member and who do I contact?
                    </div>
<div class="collapsible-body">
<span>
...
<div class="center-align">
<h4 class="">Programs and Committees</h4>
<h6 class="blue-grey-text text-darken-4">
                     
                </h6>
</div>
...
<li class="">
<div class="collapsible-header">
<i class="material-icons">info_outline</i> What happens during the monthly membership meetings?
                    </div>
<div class="collapsible-body">
<span>
<p>The monthly meetings are held on the morning of the second Thursday of each month at the Capital Grille (Perimeter). These meetings provide time for connecting with fellow members as well as hearing from a speaker on a topical business subject.</p>
</span>
</div>
</li>
<li>
<div class="collapsible-header">
<i class="material-icons">info_outline</i> What is CEO Inflection Point (CEO-IP)?
                    </div>
<div class="collapsible-body">
<span>
<p>
...
<li>
<div class="collapsible-header">
<i class="material-icons">info_outline</i> What is the process to get on a committee?
                    </div>
<div class="collapsible-body">
<span>
...
<li class="">
<div class="collapsible-header">
<i class="material-icons">info_outline</i> What are the levels of sponsorship and how does a company become a sponsor?
                    </div>
<div class="collapsible-body">
<span>
<p>
...
<li class="">
<div class="collapsible-header">
<i class="material-icons">info_outline</i> Is there a criterion for the type of guests I can bring?
                    </div>
<div class="collapsible-body">
<span>
...
<li class="">
<div class="collapsible-header">
<i class="material-icons">info_outline</i> Are there any restriction on the number of guests I can bring and how often?
                    </div>
<div class="collapsible-body">
<span>
...
<section class="border gre lighten-4">
<div class="center-align">
<h4 class="">Membership Fees and Organizational Finances</h4>
<h6 class="blue-grey-text text-darken-4">
                     
                </h6>
</div>
...
<li class="">
<div class="collapsible-header">
<i class="material-icons">info_outline</i> What are the major operating expenses of our organization and how our membership fees and sponsorship monies used?
                    </div>
<div class="collapsible-body">
<span>
<p>
...
<li class="">
<div class="collapsible-header">
<i class="material-icons">info_outline</i> CEO Relationship with Internal &amp; External Trusted Advisors
                    </div>
<div class="collapsible-body">
<span>
<img alt="" src="<?php bloginfo("template_directory"); ?>/images/content/faq-1.png" style="margin-left:10%;" width="70%"/>
<img alt="" src="<?php bloginfo("template_directory"); ?>/images/content/faq-2.png" style="margin-left:10%;padding-top: 50px;" width="70%"/>
</span>
</div>
</li>
</ul>
