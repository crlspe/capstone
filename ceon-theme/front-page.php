...
<div class="container">
    ...
    <section class="top-section border" id="hero">
        ...
        <?php
                ...
                <div class="carousel-item black white-text hero-image" href="#" style="background-image: url(<?php bloginfo("template_directory"); ?>/images/slider/hero.png);">
                    <div class="hero-content">
                        ...
                        <a class="btn waves-effect light-blue white-text darken-text-2 bold-text-600 text-shadow-1-black"
                            ...
                            <?php echo get_field('call_to_action'); ?>
                        </a>
                        <p></p>
                    </div>
                </div>    
    ...
    <section class="border" id="personas">
        <div class="row">
            ...
            <div class="col s12 m6 l4" >
                <div class="card hoverable" style="height: auto;" data-aos="zoom-in">
                    <div class="card-image">
                        <img src="<?php bloginfo("template_directory"); ?>/images/personas/persona4.png"
                        width="271.1px"
                        height="335.5px" />
            ...
            <div class="col s12 m6 l4">
                <div class="card hoverable" style="height: auto;" data-aos="zoom-in">
                    <div class="card-image">
                        <img src="<?php bloginfo("template_directory"); ?>/images/personas/persona5.png"
                        width="271.1px"
                        height="335.5px" />
                    </div>
                    <div class="card-content" style="min-height:240px;">
        ...
        <div class="row">
            <div class="col s16 m5">
                <div class="card" style="margin: 3px;" data-aos="fade-right">
                    <div class="card-image">
                        <img src="<?php bloginfo("template_directory"); ?>/images/content/Events.png" alt="" style="height: 400px; object-fit: cover;">
                    </div>
                </div>
            </div>
    ...
    <section id="outreach-programs" class="section scrollspy grey lighten-4 border" style="padding-bottom: 0;">
        ...
        <div class="outreach-grid">
            ...
            <div>
                ...
                <div class="col s12 m6 card-image" style="margin-bottom: 5px; margin-top: 7px;" data-aos="zoom-in">
                    <img alt="" src="<?php bloginfo("template_directory"); ?>/images/outreach/outreach4.png"
        ...
        <div class="row" style="margin-bottom: 0px;">
            <div class="card-image col s12 l8" style="padding-right:5px;padding-left:0px; max-height:343px; margin-top: 7px;" data-aos="zoom-in">
                <img alt="" src="<?php bloginfo("template_directory"); ?>/images/outreach/outreach5.jpg"
        ...
        <div class="row" style="margin-bottom: 0px;">
            <div class="col s12 l4" style="padding-right:5px;padding-left:0px;">
                <div class="card-panel hoverable grey lighten-4" data-aos="zoom-in" style="height: 304px;">
                    ...
                    <div class="card-action center-align">
                        <a class="btn grey lighten-2 black-text" href="<?php echo get_permalink(
                            get_page_by_path('insight-plus')); ?>">Learn More</a>
                    </div>
                </div>
            </div>
            <div class="col s12 l4" style="padding-right:5px;padding-left:0px;">
            ...
            <div class="col s12 l4" style="padding-right:5px;padding-left:0px;">
                <div class="card-panel hoverable ceon-blue" data-aos="zoom-in" style="height: 304px;">
                    ...
                    <div class="card-action center-align">
                        <a class="btn grey lighten-2 black-text" href="<?php echo get_permalink(
                            get_page_by_path('speaker-series')); ?>">Learn More</a>
                    </div>
                </div>
            </div>
        </div>
