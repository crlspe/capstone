...
<div class="container">
    ...
    <div class="top-section page-title">
        ...
        <div class="card" style="margin: 0px;">
            <div class="card-image">
                <img alt="" class="image-title" src="<?php bloginfo("template_directory"); ?>/images/titles/publications.jpg"/>
            </div>
        </div>
    </div> 
    <!-- /TITLE -->
    ...
    <div class="row center-align" style="margin-bottom: 0px;">
        <div class="col s10 offset-s1 grey lighten-4" style="padding: 0 15px;">
