...
<nav class="fixed-header" style="max-width: 100%;">
    <div class="nav-wrapper white">
        <a class="brand-logo" href="#!">
            <img alt="" class="hide-on-large-only" height="90" src="<?php bloginfo("template_directory");
...
<ul class="sidenav sidenav-fixed" id="mobile-menu">
    <li>
        <div class="user-view center">
            ...
            <a class="btn  btn-small grey lighten-4 black-text flow-text" href="<?php echo home_url(); ?>"
                style="text-transform: capitalize; padding: 2px 15px 2px 15px;">
                Back to Website
    ...
    <li>
        ...
        <div class="collapsible-body" style="display: block;">
            <ul>
                ...
                <li class="">
                    <a class="black-text" href="<?php echo get_permalink( get_page_by_path('mentor-feedback')); ?>">
                        <i class="material-icons tiny" style="margin: 0;">portrait</i> Mentor Feedback
                    </a>
                </li>
                <li class="">
                    <a class="black-text" href="<?php echo get_permalink( get_page_by_path('member-inflection')); ?>">
                        <i class="material-icons tiny" style="margin: 0;">show_chart</i> Grow your Business
                    </a>
                </li>
                <li class="">
    ...
    <li>
        ...
        <div class="collapsible-content">
            <ul>
                <li class="">
                    <a class="black-text" href="<?php echo get_permalink( get_page_by_path('member-speaker')); ?>">
                ...
                <li class="">
                    <a class="black-text" href="<?php echo get_permalink( get_page_by_path('member-insight-plus')); ?>">
                        <i class="material-icons tiny" style="margin: 0;"> lens</i> 
                        Insight Plus
                    </a>
                </li>
            </ul>
    ...
    <li>
        ...
        <div class="collapsible-content">
            <ul>
                ...
                <li>
                    <a class="black-text" href="https://ksu-teama.ceonetweavers.org/wp-content/uploads/2021/11/CEO-Netweavers-Orientation_July-21-2021-v1pptx.pdf">
                        <i class="material-icons tiny" style="margin: 0;">featured_video</i>New Member Orientation
                    </a>
                </li>
                <li>
                    <a class="black-text" href="<?php echo get_permalink( get_page_by_path('member-faq')); ?>">
                        <i class="material-icons tiny" style="margin: 0;">question_answer</i> FAQ
                    </a>
                </li>
            </ul>
        </div>
    ...
    <li class="divider"></li>
    <li>
        <a class="waves-effect" href="<?php echo get_permalink( get_page_by_path('member-publications')); ?>">
